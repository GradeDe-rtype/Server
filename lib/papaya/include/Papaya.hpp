...
public:
   ...
   */
  bool hasData(const std::string &refKey, const std::string &refValue,
   ...
   */
  std::vector<std::string> getLine(const std::string &key,
   ...
   */
  std::string getData(const std::string &refKey, const std::string &refValue,
                      const std::string &key) const;
   ...
   */
  void removeData(const std::string &refKey, const std::string &refValue,
   ...
   */
  void updateData(const std::string &refKey, const std::string &refValue,
   ...
   */
  void updateLine(const std::string &refKey, const std::string &refValue,
...
private:
   ...
   */
  void _checkKeys(const std::vector<std::string> &keys,
